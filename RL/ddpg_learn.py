...
class DDPGagent(object):
    ...
    def load_weights(self, path):
        self.actor.load_weights(path + 'pendulum_actor_trial'+str(trial)+'.h5')
        self.critic.load_weights(path + 'pendulum_critic_trial'+str(trial)+'.h5')
    ...
    def train(self, max_episode_num, trial):
        ...
        for ep in range(int(max_episode_num)):
            ...
            #print('Now save')
            self.actor.save_weights('./save_weights/pendulum_actor_trial'+str(trial)+'.h5')
            self.critic.save_weights('./save_weights/pendulum_critic_trial'+str(trial)+'.h5')

        np.savetxt('./save_weights/pendulum_epi_reward_trial'+str(trial)+'.txt', self.save_epi_reward)
